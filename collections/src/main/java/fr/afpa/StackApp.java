...
public class StackApp {
    public static void main(String[] args) {
        ...
        // Ressources :
        // https://www.jmdoudoux.fr/java/dej/chap-collections.htm#collections-5 -> crtl
        // + F : 14.6.7.1. L'interface java.util.Deque
        ...
        System.out
                .println("L'élément est en " + stack.search("Blue") + "eme position par rapport au dessus de la pile");

        // Quid des pollFirst(); pollLast();
        // stack.pollFirst();
    }
}
